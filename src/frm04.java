...
public class frm04 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(140, 250, 120, 40);

        lblRe.setBackground(new java.awt.Color(255, 255, 255));
        lblRe.setForeground(new java.awt.Color(0, 0, 0));
        lblRe.setOpaque(true);
        jPanel1.add(lblRe);
        lblRe.setBounds(10, 200, 390, 30);

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/16 (Phone).jpg"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    public boolean isNumber(String numero) {
        ...
        public void Multiplo2x3(){
          if (isNumber(txtNum.getText())) {
            int Number = Integer.parseInt(txtNum.getText());
            if (Number <= 0) {
                JOptionPane.showMessageDialog(this,
                        "Numero no valido, digite un numero mayor a cero",
                        "Valor Incorrecto", JOptionPane.ERROR_MESSAGE);
                txtNum.setText("");
            } else {
                if (Number % 2 == 0 && Number % 3 == 0) {
                    lblRe.setText("El numero ingresado es mulitiplo de 2 y de 3");
                } else {
                    lblRe.setText("El numero ingresado no es multiplo de 2 y de 3");
                }
            }
        }
    }
